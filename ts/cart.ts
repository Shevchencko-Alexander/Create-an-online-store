...
const cartTotalValue: HTMLElement | null = document.querySelector(
   '.cart__total-result'
);

export let cartItems: Product[] = !localStorage.cartItems
   ? []
...
const createItemCart = (elem: Product) => {
   return `
...
const addDeleteCartItem = () => {
   const allAddBtn: NodeListOf<HTMLImageElement> =
      document.querySelectorAll('.elem__arrow-up');
   const allDeleteBtn: NodeListOf<HTMLImageElement> =
      document.querySelectorAll('.elem__arrow-down');
   const allCartItems: NodeListOf<HTMLElement> =
      document.querySelectorAll('.cart__elem');
...
const removeCartItem = () => {
   const allRemoveBtn: NodeListOf<HTMLSpanElement> =
      document.querySelectorAll('.elem__remove');
   const allCartItems: NodeListOf<HTMLElement> =
      document.querySelectorAll('.cart__elem');
...
export const fillListItemsCart = (cartItems: Product[]) => {
